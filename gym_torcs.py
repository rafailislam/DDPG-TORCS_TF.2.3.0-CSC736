...
class TorcsEnv:
    terminal_judge_start = 100 #100  # If after 100 timestep still no progress, terminated
    termination_limit_progress = 5 #5  # [km/h], episode terminates if car is running slower than this limit
    default_speed = 50
